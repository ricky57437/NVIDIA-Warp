    ...
    def render(self):
        ...
        with wp.ScopedTimer("render"):
            ...
            self.renderer.render_box(
                ...
                pos=base + wp.vec3(0.0, -extenty, 0.0),
                #extents that push out to create the wall from one single point
                extents=wp.vec3(extentx, wall_thickness, extentx),
                rot=wp.quat_identity(),
                color=Gf.Vec3f(0.0, 0.0, 1.0),  # RGB Blue
            )
            # top
            self.renderer.render_box(
                name="top",
            ...
            self.renderer.render_box(
                name="back",
                pos=base + wp.vec3(0.0, 0.0, -extentx),
                extents=wp.vec3(extentx, extenty, wall_thickness),
                rot=wp.quat_identity(),
                color=Gf.Vec3f(0.0, 0.0, 1.0),
            )
            ...
            self.renderer.render_box(
                name="left",
                pos=base + wp.vec3(-extentx, 0.0, 0.0),
                extents=wp.vec3(wall_thickness, extenty, extentx),
                rot=wp.quat_identity(),
                color=Gf.Vec3f(0.0, 0.0, 1.0),
            )
